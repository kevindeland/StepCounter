...
public class GraphActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public String TAG = "Accelerometer";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        xyzHistoryPlot.setRangeBoundaries(-15, 15, BoundaryMode.FIXED);
        ...
        xyzHistoryPlot.setRangeLabel("acceleration (m/s)");
    ...
    public void saveData(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                ...
                String filename = "accel_" + (new Random()).nextInt(1000) + ".csv";
